...
const AdminDashboard: React.FC = () => {
    ...
    return (
        <Authenticator>
            {({ signOut, user }) => (
                <div className="min-h-screen bg-gray-50 py-24 px-6 lg:px-20">
                    <div className="max-w-6xl mx-auto">
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
                            ...
                            <div className="flex gap-4">
                                <button
                                    ...
                                    className="px-6 py-2 border border-gray-200 text-sm hover:bg-gray-100 transition-colors"
                                >
                                    Refresh
                                </button>
                                <button
                                    onClick={signOut}
                                    className="px-6 py-2 bg-studio-dark text-white text-sm hover:bg-studio-blue transition-colors"
                                >
                                    Sign Out
                                </button>
                            </div>
                        ...
                        {loading ? (
                            <div className="flex justify-center py-20">
                                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-studio-blue"></div>
                            </div>
                        ) : (
                            <div className="grid gap-6">
                                {messages.length === 0 ? (
                                    ...
                                    messages.map((msg) => (
                                        <div key={msg.id} className="bg-white p-8 border border-gray-100 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                                            <div className="flex justify-between items-start mb-4">
                                                <div>
                                                    <span className="text-[10px] font-mono uppercase tracking-widest text-studio-blue mb-2 block">
                                                ...
                                                <button
                                                    ...
                                                    className="text-red-400 hover:text-red-600 transition-colors text-xs uppercase tracking-widest font-mono"
                                                >
                                                    Delete
                                                </button>
                                            </div>
