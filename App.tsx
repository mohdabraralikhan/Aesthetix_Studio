...
const NAV_ITEMS: NavItem[] = [
  { label: 'Work', id: SectionId.WORK, jpLabel: '仕事' },
  { label: 'Services', id: SectionId.SERVICES, jpLabel: 'サービス' },
  { label: 'Process', id: SectionId.PROCESS, jpLabel: 'プロセス' },
  { label: 'About', id: SectionId.ABOUT, jpLabel: '約' },
  { label: 'Contact', id: SectionId.CONTACT, jpLabel: '接触' },
];
          ...
          <div className="hidden lg:flex items-center gap-12">
            {NAV_ITEMS.map((item) => (
              ...
              >
                ...
                <span className="absolute -bottom-3 opacity-0 group-hover:opacity-100 group-hover:bottom-[-4px] transition-all duration-300 font-jp text-[10px] text-gray-400">
                  {item.jpLabel}
                </span>
              </button>
            ))}
        ...
        <div className="flex flex-col items-center justify-center h-full gap-8">
           {NAV_ITEMS.map((item, index) => (
              ...
              >
                ...
                <span className="block text-xs font-jp text-gray-400 mt-2 tracking-widest text-center">{item.jpLabel}</span>
              </button>
            ))}
        </div>
      </div>
